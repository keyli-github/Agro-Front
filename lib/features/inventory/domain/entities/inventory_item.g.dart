...
extension InventoryItemQuerySortBy
  ...
  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> sortByItemId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'itemId', Sort.asc);
    });
  }

  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> sortByItemIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryItemQuerySortThenBy
  ...
  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> thenByItemId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'itemId', Sort.asc);
    });
  }

  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> thenByItemIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'itemId', Sort.desc);
    });
  }
...
extension InventoryItemQueryWhereDistinct
  ...
  QueryBuilder<InventoryItem, InventoryItem, QDistinct> distinctByItemId({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryItemQueryProperty
  ...
  QueryBuilder<InventoryItem, String, QQueryOperations> itemIdProperty() {
    return QueryBuilder.apply(this, (query) {

...
class FumigateDetailPage extends StatelessWidget {
  final bool isOptimal; // true = Día óptimo, false = No recomendado
  
  const FumigateDetailPage({
    super.key,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'Equivocarse en el día o dosis hace que el fungicida se pierda y cueste dinero. Aquí registramos cada decisión para evitar repetir esa historia.',
                        style: TextStyle(
                          fontSize: 12,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          // Condiciones óptimas para fumigación
          _buildConditionItem(
            icon: Icons.water_drop,
            text: 'Humedad alta 80%',
            color: const Color(0xFF2196F3),
          ),
          const SizedBox(height: 8),
          _buildConditionItem(
            icon: Icons.check,
            text: 'Ventana ideal fungicida',
            color: AppColors.actionGreen,
          ),
          const SizedBox(height: 8),
          _buildConditionItem(
            icon: Icons.check,
            text: 'Cobertura máxima',
            color: AppColors.actionGreen,
          ),
          const SizedBox(height: 16),
          // Botón empezar fumigación
          Center(
            child: OutlinedButton(
              onPressed: () {},
              style: OutlinedButton.styleFrom(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              isOptimal
                  ? 'Perfecto para roya...'
                  : 'Si hoy fumigas, perderás efectividad. Avísame y lo ajustamos bien.',
              style: TextStyle(
                fontSize: 13,
                color: isOptimal ? const Color(0xFF2E7D32) : AppColors.textDark,
                height: 1.5,
                fontWeight: FontWeight.w500,
              ),
            ),
          ...
          Container(
            ...
            child: const Text(
              'Recibe recomendaciones específicas por un ingeniero capacitado. Te recomienda qué fungicida aplicar, cuánto y cuándo. Incluye envío de fotos de tu cafetal para análisis preciso.',
              style: TextStyle(
                fontSize: 12,
                color: Color(0xFF616161),
                height: 1.5,
